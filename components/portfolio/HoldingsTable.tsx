  ...
  if (!holdings || holdings.length === 0) {
    return (
      <div className="bg-bg-surface-alt border border-border">
        ...
        <div className="text-text-dim text-[11px] px-3 py-8 text-center">No holdings found</div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-bg-surface-alt border border-border">
      ...
      {sorted.map((h) => {
        ...
        return (
          <div key={h.tradingsymbol + h.exchange} className={`grid grid-cols-[1.5fr_0.5fr_1fr_1fr_1fr_1fr] px-3 py-1.5 text-[11px] border-b border-[#111] items-center ${isLoss ? "bg-loss-row" : ""}`}>
